...
bitflags! {
    ...
    pub struct BEHAVIOR_METHOD_IDENTIFIERS: u32 {
        /// Raise a click event.
        const DO_CLICK = 1;
        ...
        /// `VALUE_PARAMS`
        const GET_VALUE = 0xFD;
        /// `VALUE_PARAMS`
        const SET_VALUE = 0xFE;
        ...
        const FIRST_APPLICATION_METHOD_ID = 0x100;
    }
}
...
bitflags! {
    ...
    pub struct PHASE_MASK: u32 {
        ...
        const SINKING = 0x0_8000;
        /// Bubbling event consumed by some element.
        const BUBBLING_HANDLED = 0x1_0000;
        /// Sinking event consumed by some child.
        const SINKING_HANDLED = 0x1_8000;
    }
}
...
bitflags! {
    ...
    pub struct CLICK_REASON: u32 {
        /// By mouse button.
        const BY_MOUSE_CLICK = 0;
        /// By keyboard (e.g. spacebar).
        const BY_KEY_CLICK = 1;
        /// Synthesized, by code.
        const SYNTHESIZED = 2;
        /// Icon click, e.g. arrow icon on drop-down select.
        const BY_MOUSE_ON_ICON = 3;
    }
}
